...
public class HistoriaAdapter extends android.support.v4.widget.CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        strTagMenosInicio = "<small><small><font color= '#9a0707'>";
        strTagMenosFin = "</font></small></small><br/>";
        strTagMasInicio = "<small><small><font color= '#226f45'>";
        strTagMasFin = "</font></small></small><br/>";
